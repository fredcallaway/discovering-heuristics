...
<!-- We hypothesized two explanations for the small effect of cue honesty for the *no feedback* condition.
Perhaps participants in who don't see feedback are be unable to identify the correlation of the cue and outcome.
Alternatively, they could identify the relationship, but fail to use this knowledge to make predictions. -->
...
Second, simulations are costly, and it is possible that increased attentional and working memory load may have decreased participants' ability to simultaneously perform the task *and* pick up on the cue.
